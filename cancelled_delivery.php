...
<body>
   ...
   <section class="orders">
      ...
      <?php
      $select_orders = mysqli_query($conn, "SELECT * FROM `orders` WHERE delivery_status = 'Cancelled'") or die('query failed');
      ?>
      ...
      <?php } else { ?>
         <p class="empty">There are no cancelled deliveries.</p>
      <?php } ?>
